# -*- coding: utf-8 -*-
"""
Created on Fri Mar 31 13:00:05 2023
...
# function used for logo detection
# 


def logo_det_api1(img,key):
...
def model_logo_detection(email,key):
    
    img=get_logo_signature(email)
    if img ==False:
        return 0,0
    else:
        info=logo_det_api1(img,key)
